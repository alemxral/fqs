#!/usr/bin/env python3
"""
Main function to fetch current positions from Polymarket Data API /positions endpoint
"""
...
def get_current_positions(
    ...
    Examples:
        ...
        positions = get_current_positions(
            user="0xF937dBe9976Ac34157b30DD55BDbf248458F6b43",
            market=["0x1234567890abcdef...", "0xfedcba0987654321..."]
        )
        
        # Get large positions sorted by PnL
        positions = get_current_positions(
            user="0xF937dBe9976Ac34157b30DD55BDbf248458F6b43",
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n2. Getting positions with specific fields...")
        specific = get_current_positions(
            test_user, 
            fields=["market", "size", "value"],
            limit=3
        )
